...
- [ ] T020 [P] Test de escala: sembrar un Work Item con ~50 hijos directos y una cadena de ~20 niveles de profundidad, verificar que la detección de ciclos (T004) y `getWorkItemRelations` (T012) no degradan perceptiblemente (SC-001 a SC-004 de spec.md) — pendiente; no se hizo un test de escala dedicado. La consulta `WITH RECURSIVE` de T004 no tiene una razón teórica para degradar con la profundidad indicada (research.md), pero eso no reemplaza medirlo.
