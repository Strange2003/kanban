...
3. [`specs/`](specs/) — one directory per feature, numbered (`001-accounts-invitations` … `004-work-items` for Phase 1, then `005-work-item-relationships`, `006-work-item-detail-view`, `007-roles-permissions` for Phase 2, and `008-work-item-fields`, `009-work-item-views` for Phase 3). Each feature directory can contain:
